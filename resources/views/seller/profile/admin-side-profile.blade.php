        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="cash_on_delivery_status" type="checkbox" <?php /* @if ($user->shop->cash_on_delivery_status == 1) checked @endif */ ?> >
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <label class="aiz-switch aiz-switch-success mb-3">
                            <input value="1" name="bank_payment_status" type="checkbox" <?php /* @if ($user->shop->bank_payment_status == 1) checked @endif */ ?> >
                            <span class="slider round"></span>
                        </label>
                    </div>
                </div>
