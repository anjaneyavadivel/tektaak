...
@php
$combined_order = \App\Models\CombinedOrder::findOrFail(Session::get('combined_order_id'));
...
@endphp
        ...
        //dd($combined_order);
            ...
            curl_setopt_array($curl, array(
                ...
                CURLOPT_POSTFIELDS => "transaction_amount=".\App\Models\CombinedOrder::findOrFail(Session::get('combined_order_id'))->grand_total ."&currency=". \App\Models\Currency::findOrFail(get_setting('system_default_currency'))->code."&customer_address=".$shipping_address['address']."&customer_city=".$shipping_address['city']."&billing_country=".$shipping_address['country']."&billing_state=".$shipping_address['state']."&billing_postal_code=".$shipping_address['postal_code']."&customer_name=".$shipping_address['name']."&customer_email=".$shipping_address['email']."&customer_mobile=".$shipping_address['phone'],
